...
const Login = () => {
  return (
    <>
      <div className="flex flex-col items-center justify-items-start gap-10 my-15 min-h-screen">
        <h1 className="text-3xl font-extrabold">Login to Get Started</h1>
        <div className="flex flex-col gap-4  w-[50vw]  items-center justify-center rounded-lg shadow-lg">
          <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 w-60">
            <svg
