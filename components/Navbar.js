  ...
  return (
    <nav className="flex bg-gray-900 items-center justify-between px-20 py-4">
      ...
      <div className="relative flex justify-center items-center  md:block gap-4">
        {session && (
          <>
            ...
            <div
              ...
              className={`z-10 ${
                showdropdown ? "" : "hidden"
              } absolute left-3.75 top-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}
            >
              <ul
        ...
        {!session && (
          <Link href={"/login"}>
            <button className="text-white bg-linear-to-br from-purple-600 to-blue-500 hover:bg-linear-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 ">
              Login
            </button>
          </Link>
        )}
